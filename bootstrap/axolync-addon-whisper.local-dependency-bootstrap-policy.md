...
This policy exists to stop the recurring "declared package exists in `package.json`, but local package/build/test entrypoints still crash after pull" class of regressions.
