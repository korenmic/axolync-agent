...
- [x] 4. Add a `## Deploying Skills` section near the top of `README.md` prominently naming the three skills, linking their SKILL.md files, and stating the cold-bootstrap property (procedure works by reading before the skills are installed).
