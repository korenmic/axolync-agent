...
Use the active multi-repo workspace root, not the current repo root.
...
- Only fall back to the current working directory when no broader workspace root is established.
